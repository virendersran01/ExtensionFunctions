...
private fun String.addSpaceInEnd(): String {
    return this.trimEnd().plus(" ")
}

//textDescription.setResizableText(it.description.addSpaceInEnd(), 4, true)

//https://dzolnai.medium.com/a-proper-solution-for-expanding-a-textview-with-a-read-more-button-546e8a4e8d95
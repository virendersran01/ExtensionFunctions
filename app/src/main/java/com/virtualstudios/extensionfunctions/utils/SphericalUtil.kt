...
object SphericalUtil {
    ...
    fun computeHeading(from: LatLng, to: LatLng): Double {
        ...
        val heading = atan2(
            sin(dLng) * cos(toLat), cos(fromLat)
    ...
    fun computeOffset(
        ...
        val sinLat = cosDistance * sinFromLat + (sinDistance * cosFromLat
                * cos(heading))
        val dLng = atan2(
    ...
    private fun polarTriangleArea(
        tan1: Double, lng1: Double,
        tan2: Double, lng2: Double
    ): Double {

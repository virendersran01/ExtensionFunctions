...
fun ConstraintLayout.addChildOnStack(
    ...
    constraintSet.connect(child.id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END)
...
internal fun ConstraintLayout.addChildOnRow(
    ...
    val constraintSet = ConstraintSet()
    constraintSet.clone(this)
    constraintSet.connect(child.id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP)
    constraintSet.connect(
        child.id,
